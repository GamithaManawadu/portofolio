...
const Hero = () => {
  return (              //background img
    <section className={`relative w-full h-screen mx-auto`}>Hero 
      <div className={`absolute inset-0 top-[120px]  max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`} //top text
      > 
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Gamitha</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop web applications, user <br className='sm:block hidden' />
            interfaces and a enthusiast in AI/ML.
          </p>
        </div>
      </div>
